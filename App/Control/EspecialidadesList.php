 ...
 * Listagem de Pessoas
 */
class EspecialidadesList extends Page
{
    ...
    public function __construct()
    {
        ...
        $this->form = new FormWrapper(new Form('form_busca_especialidades'));
        ...
        $this->form->addAction('Novo', new Action(array(new EspecialidadesForm,'onEdit')));
        ...
        $this->datagrid->addAction( 'Editar',  new Action([new EspecialidadesForm, 'onEdit']), 'id', 'fa fa-edit fa-lg blue');
    ...
    public function onReload()
    {
        ...
        $repository = new Repository('Especialidades');
        ...
        $especialidades = $repository->load($criteria);
        $this->datagrid->clear();
        if($especialidades)
        {
            foreach($especialidades as $especialidade)
            {
                $this->datagrid->addItem($especialidade);
            }
        }
        Transaction::close();
        $this->loaded = true;
    ...
    public function Delete($param)
    {
        try
        {
            ...
            $especialidades->delete(); // deleta objeto do banco de dados
