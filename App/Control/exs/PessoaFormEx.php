...
class PessoaFormEx extends Page
{
    private $form;
    ...
    public function __construct()
    {
        ...
        $this->form->setTitle('Pessoa 2 (teste)');
    ...
    public function onEdit($param)
    {
        try
        {
            if (isset($param['id']))
            {
                ...
                if ($pessoa)
                {
                    $pessoa->ids_grupos = $pessoa->getIdsGrupos();//Pegaos ids dos grupos da classe que esta no Model/Pessoa função getIdsGrupos
